...
{	
	 ...
	 * in the list.
	 * Preconditions: A valid ListADT object exists
	 * Postconditions: ListADT's size is returned
	 ...
	 * this call returns.
	 * Preconditions: A valid ListADT object exists
	 * Postconditions: ListADT is cleared (all elements are removed)/.
	 */
	public void clear();
	 ...
	 * Preconditions: A valid ListADT object exists, index and object to be added are provided
	 * Postconditions: The object is added at the specified index.
	 * @param index
